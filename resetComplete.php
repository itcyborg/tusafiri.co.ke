        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 to-animate">
                    <hr>
                    <br>
                    <p style="padding: 30px;">An email has been sent to the provided email if found with instructions on
                        how to regain access your account. go back to <a href="login.php">Login</a> or <a
                                href="register.php">Register a new account</a></p>
                    <br>
                    <hr>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-lg-3 col-lg">
                    ...
                    <ul class="social-media">
                        ...
                        <li><a href="https://www.twitter.com/Tusafiri_KE" class="twitter"><i
