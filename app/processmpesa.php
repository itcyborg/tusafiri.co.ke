...
if (isset($_POST['mpesacomplete'])) {
    ...
    if (!$db->isError()) {
        ...
        <h3>Payment made</h3>
        <p>Hey, </p>
        <p>We have recieved your payment for order # $invoice made via M-Pesa ID: $tid and is awaiting confirmation. 
        <br>
        You will be notified via email once the email has been confirmed.
        <br>
        <br>
        </p>
...
<head>
    ...
    <title>Tusafiri-Mpesa complete</title>
    ...
    <meta name="google-signin-client_id"
          content="790717079724-ipugme6a8ua7oat501rr7abepjt3130p.apps.googleusercontent.com">
...
<section id="fh5co-services">
    ...
    <div class="container">
        <div class="row">
            <h3>Payment has been made</h3>
            <p>Thank you for making the payment for order # <?php echo $invoice; ?>, you will receive an email
                confirming receipt of the payment.</p>
            <hr>
            <a href="../index.php" class="btn btn-primary"><i class="glyphicon glyphicon-home"> Back Home</i></a>
        </div>
    </div>
</section>
<hr>
