...
if(isset($_GET['id'])){
    $tripid=$_GET['id'];
    $db=new PDO("mysql:host=localhost;dbname=kiboit_tusafiri", 'kiboit_tusafiri','{@dE*Zby?llT' );
    $sql="SELECT trips.*,users.Username,users.uniqueID,users.Email,users.ProfPic FROM trips JOIN users ON users.uniqueID=trips.ByUser WHERE trips.Post='YES' && trips.UQID='$tripid'";
    $res=$db->query($sql);
    if($res->rowCount()==1){
        ...
        foreach ($results as $result) {
            ...
            foreach ($photos as $key=>$photo) {
                ...
                if($key==0){
                    $indicators.="<li data-target='#bootstrap-touch-slider' data-slide-to='$key' class='active'></li>";
                    $pics.="    <!-- Third Slide -->
                                <div class='item active'>
                
                                    <!-- Slide Background -->
                                    <img src='$photo' alt='Bootstrap Touch Slider'  class='slide-image'/>
                                    <div class='bs-slider-overlay'></div>
                                </div>
                                <!-- End of Slide -->";
                }else{
                    $indicators.="<li data-target='#bootstrap-touch-slider' data-slide-to='$key'></li>";
                    $pics.="    <!-- Third Slide -->
                                <div class='item'>
            ...
            $output= "
                <div class='container-fluid'>
                    <div class='container'>
                        <div class='col-lg-7 col-md-7 col-sm-12' id='slider'>
                        ...
                        <div class='col-lg-5 col-md-5 col-sm-12'>
                            <div class='row col-md-12 col-lg-12 col-sm-12'>
                                <div class='col-sm-8 col-lg-8 col-md-8'>
                                    <img src='$profile' id='defimg' class='img-circle'>
                                </div>
                                <div class='col-md-4 col-sm-4 col-lg-4'>$username</div>
                            </div>
                            <div class='row col-md-12 col-lg-12 col-sm-12 text-center'>
                                <hr>
                                <h2>KSHS $cost per $per</h2>
                                <h3>$start to $stop</h3>
                                <h3>$slots $per</h3>
                    ...
                    <div class='container'>
                        <div class='col-md-12 col-sm-12 col-lg-12' style='padding: 4em;'>
                            <button class='btn btn-info pull-right'><i class='icon icon-support'></i> Contact Organiser</button>
                            <hr>
                            <h2>$name</h2>
                            <h3>Meeting Point: $meetingPoint, $meetingTime</h3>
                            <p>$info</p>
                        </div>
                    </div>
                </div>
