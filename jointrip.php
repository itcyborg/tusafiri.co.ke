...
<section id="fh5co-testimony" data-section="contact">
    ...
    <div class="container">
        <div class="row">
            <h2>Join Trip no: <?php echo $_GET['id']; ?></h2>
                ...
                <form action="functions/constructor.php" method="post"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <input type="text" name="fname" placeholder="First" class="form-control"><br>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <input type="text" name="lname" placeholder="Second" class="form-control"><br>
                        </div>
                    </div>
                    <div class="row">
                        Mobile Number <input type="tel" name="contact" placeholder="Mobile Number" class="form-control"><br>
                        Email <input type="email" name="email" placeholder="Email" class="form-control"><br>
                        Gender: <input type="radio" name="gender" value="Male"> Male <input type="radio" name="gender"
                                                                                            value="Female"> Female
                        <input type="radio" name="gender" value="other"> Other
                    </div>
                    <input name="trip" value="<?php echo $_GET['id']; ?>" hidden>
                    <button id="jointrip" name="jointrip" class="btn btn-primary btn-lg pull-right">Join</button>
                </form>
            </div>
        </div>
    </div>
