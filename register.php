                ...
                <form action="functions/constructor.php" method="post" class="col-md-6 col-lg-offset-2 col-md-offset-2 col-lg-6 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            Password
                            <input type="password" required name="password" id="password" minlength="6" class="form-control" placeholder="Password">
                        </div>
                        <div class="col-md-6 col-lg-6">
                            Confirm Password
                            <input type="password" required name="cpassword" id="cpassword" minlength="6" class="form-control" placeholder="Confirm Password">
                        </div>
                    </div><br>
                    <button id="register" name="register" class="btn btn-primary pull-right">Register</button>
                </form>
            </div>
        </div>
    </div>
    ...
    $('document').ready(function () {
        $('#cpassword,#password').keyup(function () {
            if($('#cpassword').val()!==$('#password').val()){
                $('#cpassword').removeClass('alert-success');
                $('#cpassword').addClass('alert-danger');
